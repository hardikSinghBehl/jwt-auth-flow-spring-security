...
public class UserLoginRequestDto implements Serializable {
	...
	@Schema(requiredMode = RequiredMode.REQUIRED, name = "emailId", example = "hardik.behl7444@gmail.com", description = "email-id associated with user account already created in the system")
